...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Access-Control-Allow-Headers Origin, X-Requested-With, Content, Accept, Content-Type, Content-Length, Authorization')
